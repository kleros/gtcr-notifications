...
module.exports = {
  ...
  MESSAGES: {
    ...
    [SUBMISSION_ACCEPTED]:
      '{{nickname}}, a submission you participated in was accepted into the registry. Deposits were transferred out of the contract but there may be rewards pending withdrawal for appeal fee contributors.',
    [REMOVAL_ACCEPTED]:
      '{{nickname}}, a removal you participated in was executed and the item was removed from the registry. Deposits were transferred out of the contract but there may be rewards pending withdrawal for appeal fee contributors.',
